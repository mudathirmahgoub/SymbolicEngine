...
public class SmtBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements SmtVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitType(SmtParser.TypeContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitValue(SmtParser.ValueContext ctx) { return visitChildren(ctx); }
}